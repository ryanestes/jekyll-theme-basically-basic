...
- Windows 10
<!--more-->
In case you are completely unaware or need a refresher on virtualization or virtual machines, here is a few good resources for a high-level overview (Links to external websites):
...
2. Alter the following fields and then click **Next** :
...
3. Kali Linux recommends a minimum of 2GB of RAM for optimal performance, change the RAM to **2048** MB (2 GB).

![VB-Kali-ISO-3](/assets/images/05/VB-Kali-ISO-3.png)

4. This step in the process is for virtual machine hard disk creation. Don't change anything (Create a virtual hard disk now) and click **Create**

![VB-Kali-ISO-4](/assets/images/05/VB-Kali-ISO-4.png)

5. When you create a new virtual hard disk it will ask you what type you want - VDI, VHD, or VMDK. I won't go over the differences, but if you want a little overview here is information from the VirtualBox manual on the matter (I use VMDK):
...
6. This step pertains to how data is stored from the virtual machine, whether it is dynamically created or to statically allocate it beforehand and store data as necessary. There is now an option to partition storage into less than 2GB chunks as well. The most popular and recommended action is to select **Dynamically allocated** (don't change anything) and click **Next**.

![VB-Kali-ISO-6](/assets/images/05/VB-Kali-ISO-6.png)

7. The final step in the inital setup process is to allocate hard drive space for storage from the virtual machine. Kali Linux recommended **20GB** so thats what I will begin with. Click **Create**.

![VB-Kali-ISO-7](/assets/images/05/VB-Kali-ISO-7.png)

8. Once the machine is created you will now have a vanilla Debian Linux operating system, but it is not yet Kali Linux. You need to add the ISO file as a boot option. Click **Settings** when your virtual machine is selected onthe left.

![VB-Kali-ISO-8](/assets/images/05/VB-Kali-ISO-8.png)

9. Then, click **Storage** on the left-hand side column.

![VB-Kali-ISO-9](/assets/images/05/VB-Kali-ISO-9.png)

10. Click on the small icon next to _Controller: IDE_ that looks like a disk with a green plus sign (Adds optical drive).

![VB-Kali-ISO-10](/assets/images/05/VB-Kali-ISO-10.png)

11. Click on the **Add** button and the directory to your local machine will appear. Find the Kali Linux iso you downloaded prior to this.

![VB-Kali-ISO-11](/assets/images/05/VB-Kali-ISO-11.png)

12. Once you have found the file, click **Choose**.

![VB-Kali-ISO-12](/assets/images/05/VB-Kali-ISO-12.png)

13. You should see an entry under the **Controller: IDE** Storage Device. Click **OK**.

![VB-Kali-ISO-13](/assets/images/05/VB-Kali-ISO-13.png)

14. At this point the virtual machine is completely set up. You will have to run the first time installer. Click **Start**.

![VB-Kali-ISO-14](/assets/images/05/VB-Kali-ISO-14.png)

15. Select **Graphic Install** or whichever install option you prefer. Then walk through all of the set up prompts until you are met with the desktop. If you are unsure of an answer, the likely thing you should do is to just leave it blank and continue, where applicable.
...
2. Click the small folder with a green arrow icon to select a virtual appliance to import.

![VB-Kali-OVA-2](/assets/images/05/VB-Kali-OVA-2.png)

3. Find your .ova Kali Linux file that you downloaded prior, then select **Next**.

![VB-Kali-OVA-3](/assets/images/05/VB-Kali-OVA-3.png)

4. The next screen shows a summary of all of the specifications defined by your system and the .ova file definitions. Make sure everything is correct (including the _Machine Base Folder_) and click **Import**.
...
6. At this point the Kali Linux virtual machine is completely imported. Click **Start**.
...
2. Once you find the OVA file you downloaded prior, Click **Next**.

![VB-Windows-3](/assets/images/05/VB-Windows-3.png)

3. VirtualBox will then show you a summary of the configurations set by the virtual appliance file. Click **Import** if everything looks fine.

![VB-Windows-4](/assets/images/05/VB-Windows-4.png)

4. At this point, the virtual machine is completely imported. I like to **Start** it to make sure everything works before making a Snapshot.
...
2. Then click **Power Off** on the proceeding modal.

![VB-Windows-8](/assets/images/05/VB-Windows-8.png)

3. To take a snapshot, click on the icon next to the virtual machine you are trying to take a snapshot of. It looks like three bullet points with 3 lines of information.

![VB-Windows-9](/assets/images/05/VB-Windows-9.png)

4. Click **Snapshots** on the menu that opens.

![VB-Windows-10](/assets/images/05/VB-Windows-10.png)

5. Click on the **Take** icon that looks like a camera with a green plus sign.

![VB-Windows-11](/assets/images/05/VB-Windows-11.png)

6. Name the snapshot something meaningful and make a description if necessary. I just name mine something like _clean_ or _fresh_.

![VB-Windows-12](/assets/images/05/VB-Windows-12.png)

7. That's it! Once your 90 day license expires or if you break the machine, just return to this screen and click **Restore** to revent the machine state back to this point.
